...
//  ThreeHeight
//
//  Created by Linda Ochwada on 20.09.24.
//
...
int main(void) {
    ...
    // Get Lofty's height
    // -------------------------
    printf("Enter Lofty's height to the top of his/her head, in whole feets: ");
    scanf("%ld", &feet);
    printf("    ... and the inches: ");
    scanf("%ld", &inches);
    lofty = feet * inches_per_foot + inches;
    
    // Get Shorty's heightup to his/her eyes
    // -------------------------
    ...
    // -------------------------
    printf("Enter the distance between Shorty and Lofty, in whoel feet: ");
    scanf("%ld", &feet);
    printf("    ... and then inches: ");
    scanf("%ld", &inches);
    ...
    // Call the calculate_tree_height function to compute the tree's height
    tree_height = calculate_tree_height(shorty, shorty_to_lofty, lofty_to_tree, lofty);
        
    // Display the result
    printf("The height of the tree is: %.2ld inches\n", tree_height);
